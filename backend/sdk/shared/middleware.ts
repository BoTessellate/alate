 ...
 *
 * TODO: [UPSTASH-REDIS] Set up Upstash Redis for production rate limiting
 * Currently using in-memory fallback which is "best effort" in serverless.
 * Only needed when: high traffic, strict rate limiting required, or abuse issues.
 * Setup: upstash.com → create Redis DB → add UPSTASH_REDIS_REST_URL/TOKEN to env.
 * See Claude.md "Notes for Later #9" for full instructions.
 */
